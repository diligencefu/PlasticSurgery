...
- (id) initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIButton *delectButton = [[UIButton alloc]initWithFrame:CGRectMake(self.frame.size.width - 65 , (self.frame.size.height - 30.0f / 2), 75, 40)];
        [delectButton setTitleColor:[UIColor colorWithWhite:0.498 alpha:1.000] forState:UIControlStateNormal];
        [delectButton setContentEdgeInsets:UIEdgeInsetsMake(0, 20, 0, 0)];
