//
//  FYHDistributionViewController.swift
//  healthAndBeautyUser
//
...
class FYHDistributionViewController: Base2ViewController {
    ...
    override func configSubViews() {
        setupTitleViewSectionStyle(titleStr: "分销明细")
        ...
        mainTableView.register(UINib(nibName: "FYHDistributionDetailCell", bundle: nil), forCellReuseIdentifier: identyfierTable)
    ...
    override func requestData() {
        ...
        SVPWillShow("加载中...")
        Alamofire.request(commissions_api,
                          method: .get,
                          parameters: params,
                          ...
                          headers: nil).responseJSON {
                            ...
                            case .success:
                                if let j = response.result.value {
                                    ...
                                    let data =  JSOnDictory["data"]["commissions"].arrayValue
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let model = mainTableArr[indexPath.section] as! DistriDetailModel
        
        let cell : FYHDistributionDetailCell = tableView.dequeueReusableCell(withIdentifier: identyfierTable, for: indexPath) as! FYHDistributionDetailCell
        cell.FYHDistributionDetailCellSetValues(model: model)
        return cell
    }
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        ...
        if editingStyle == .delete {
            ...
            SVPWillShow("加载中...")
            Alamofire.request(del_Commission,
                              method: .post,
                              parameters: params1,
                              encoding: URLEncoding.default,
                              headers: nil).responseJSON {
