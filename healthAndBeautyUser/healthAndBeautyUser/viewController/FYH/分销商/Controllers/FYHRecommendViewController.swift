//
//  FYHRecommendViewController.swift
//  healthAndBeautyUser
//
...
class FYHRecommendViewController: Base2ViewController {
    ...
    override func configSubViews() {
        setupTitleViewSectionStyle(titleStr: "我的推荐")
        ...
        mainTableView.register(UINib(nibName: "FYHMyRecommendCell", bundle: nil), forCellReuseIdentifier: identyfierTable)
    ...
    override func requestData() {
        ...
        SVPWillShow("加载中...")
        Alamofire.request(recommend_Users,
                          ...
                          encoding: URLEncoding.default, headers: nil).responseJSON { (response) in
                            ...
                            case .success:
                                if let j = response.result.value {
                                    ...
                                    let data =  JSOnDictory["data"]["recommendUsers"].arrayValue
                                    ...
                                    if code == "0" {
                                        ...
                                        for index in 0..<data.count {
                                            let model = FYHMyRecModel.setValueForFYHMyRecModel(json: data[index])
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let model = mainTableArr[indexPath.row] as! FYHMyRecModel
        let cell : FYHMyRecommendCell = tableView.dequeueReusableCell(withIdentifier: identyfierTable, for: indexPath) as! FYHMyRecommendCell
        cell.FYHMyRecommendCellSetVlues(model: model)
        return cell
    }
