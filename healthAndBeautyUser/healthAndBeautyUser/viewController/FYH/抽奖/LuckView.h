...
@protocol LuckViewBeginDelegate <NSObject>
- (void)beginRequestResult;
@end
...
@property (assign, nonatomic) id<LuckViewBeginDelegate> requestDelegate;


@property (copy, nonatomic) luckBtnBlock beginLuck;
