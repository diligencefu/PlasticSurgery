//
//  NewMain_ favourableViewController.swift
//  healthAndBeautyUser
//
...
class NewMain_favourableViewController: Wx_baseViewController {
    ...
    lazy var tableView : UITableView = {
        ...
        table.register(NewsStoreProjectListTableViewCell.self, forCellReuseIdentifier: "NewsStoreProjectListTableViewCell")
    ...
    override func viewDidLoad() {
        ...
        createNaviController(title: "最新优惠", leftBtn: buildLeftBtn(), rightBtn: nil)
        buildUI()
    }
...
extension NewMain_favourableViewController: UITableViewDelegate {
...
extension NewMain_favourableViewController: UITableViewDataSource {
